    ...
    public Node Insert(IPackImage image)
    {
        ...
        else
        {
            ...
            if (dw > dh)
            {
                ...
                Child[0].Rectangle = new Rect(Rectangle.x, Rectangle.y, image.Width - 1, image.Height);
                Child[1].Rectangle = new Rect(Rectangle.x + image.Width, Rectangle.y, Rectangle.width - image.Width, image.Height);
            }
            else
            {
                ...
                Child[0].Rectangle = new Rect(Rectangle.x, Rectangle.y, Rectangle.width, image.Height - 1);
